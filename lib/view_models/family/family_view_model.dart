...
class FamilyViewModel {
  FamilyViewModel(this.familyRepository, this.imageRepository);
  ...
  Future<void> createFamily(
    ...
    if (imageFile != null) {
      ...
      await _addFamily(_familyWithImage);
    } else {
  ...
  Family _createFamilyModel(String name, FamilyMember familyMember) {
    ...
    return Family(
      (b) => b
        ..id = familyId
        ..name = name
        ..familyMembers = [familyMember].build().toBuilder(),
    );
  }

  Future<void> _addFamily(Family family) async {
